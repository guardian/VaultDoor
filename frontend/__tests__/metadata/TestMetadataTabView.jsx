...
describe("MetadataTabView.breakdownMetadataString", () => {
  it("should split a comma separated list of key=value into an object", () => {
    const totest = new MetadataTabView({
      metaDataString: "key1=value1,key2=value2,  key3=value3",
    });
...
describe("MetadataTabView", () => {
  it("should render a table for only the given keys", () => {
    ...
    const mdString =
      "t1keything=value,t2keything=value2,t3keything=value3,t2keyother=value4";

    const rendered = shallow(
      <MetadataTabView
        tabNames={tabNames}
        tabPrefixes={prefixes}
        metaDataString={mdString}
      />
    );
