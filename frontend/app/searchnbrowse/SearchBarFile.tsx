...
const SearchBarFile: React.FC<SearchBarFileProps> = (props) => {
  ...
  useEffect(() => {
    ...
    const url =
      queryTerms.length > 0 ? urlBase + "?" + queryTerms.join("&") : urlBase;
  ...
  return (
    ...
    >
      ...
      <Grid item>
        ...
        <GnmTypeSelector
          id="gnmtype-selector"
          selectedType={currentGnmType}
          onChange={(newValue) => setCurrentGnmType(newValue)}
        />
      </Grid>
      <Grid item>
        ...
        >
          <MenuItem value="Descending">
            {sortField?.includes("TIME") ? "Most recent first" : "Descending"}
          </MenuItem>
          <MenuItem value="Ascending">
            {sortField?.includes("TIME") ? "Oldest first" : "Ascending"}
          </MenuItem>
        </Select>
      </Grid>
    </Grid>
