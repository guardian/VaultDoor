    ...
    switch (result.status) {
      ...
      case 404:
        this.setState({
          ...
          succeeded: false,
          lastError:
            "This item does not exist on the server or download token expired",
        });
        break;
      case 502:
      case 503:
        ...
        this.setState(
          {
            downloading: false,
            succeeded: false,
            lastError: "Server is not responding, will retry in 3s...",
          },
      ...
      default:
        this.setState({
          downloading: false,
          succeeded: false,
          lastError: "Server error, see logs",
        });
    }
  }
    ...
    return (
      <div>
        {this.state.downloading ? (
          ...
          <button onClick={this.performDownload}>
            &gt;&nbsp;&nbsp;Download&nbsp;&nbsp;&lt;
          </button>
        )}
        {this.state.succeeded ? (
          <p>Download running, please check your browser downloads</p>
        ) : null}
        {this.state.lastError ? (
          <p className="error">{this.lastError}</p>
        ) : null}
      </div>
    );
  }
