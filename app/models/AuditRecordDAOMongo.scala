...
@Singleton
class AuditRecordDAOMongo @Inject() (config:Configuration,dbContext:DatabaseContext)(implicit ec:ExecutionContext) extends BaseDAO[AuditRecord] with AuditRecordDAO{
